...
# Pegasusboom    -    automatic pentest
# Copyright © 2022 Pegasus

# Pegasusboom is free software: you can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.

# PEGASUSBOOM is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
# GNU General Public License for more details.

# You should have received a copy of the GNU General Public License
# along with PEGASUSBOOM.  If not, see <http://www.gnu.org/licenses/>.
...
#PEGASUSBOOM_PATH=''     # THE PEGASUSBOOM DIRECOTRY PATH COULD BE SET HERE INSTEAD OF IN THE BASHRC FILE

if [[ "$PEGASUSBOOM_PATH" == '' ]]; then 
    PEGASUSBOOM_PATH='.'
fi

# USER WORDLISTS
USERLIST_HYDRA_SSH="$PEGASUSBOOM_PATH/user_wordlist_short.txt"
USERLIST_HYDRA_POP3="$PEGASUSBOOM_PATH/user_wordlist_short.txt"
USERLIST_HYDRA_IMAP="$PEGASUSBOOM_PATH/user_wordlist_short.txt"
USERLIST_HYDRA_RDP="$PEGASUSBOOM_PATH/user_wordlist_short.txt"
USERLIST_HYDRA_SMB="$PEGASUSBOOM_PATH/user_wordlist_short.txt"

# PASSWORD WORDLISTS
PASSLIST_HYDRA="$PEGASUSBOOM_PATH/fasttrack.txt"
...
# DIRB WORDLISTS
HTTP_WORDLIST="$PEGASUSBOOM_PATH/custom_url_wordlist.txt"
HTTP_EXTENSIONS_FILE="$PEGASUSBOOM_PATH/custom_extensions_common.txt"
...
print_help () {
    ...
    echo '      PEGASUSBOOM [ENTER]  ...and the script does the rest'
    echo
    echo '  NON-interactive mode:'
    echo '      PEGASUSBOOM -t <target_ip> -f <report_path> [-p one_or_more_phases]'
    echo 
    echo '      phases:'
